...
class CriticNet:
    ...
    def create_critic_net(self, num_states=38, num_actions=1):
        N_HIDDEN_1 = 128
        N_HIDDEN_2 = 64
        ...
        H2_c=tf.nn.relu(tf.matmul(H1_c,W2_c)+tf.matmul(critic_action_in,W2_action_c)+B2_c)
...
#        raw_input("Press Enter to continue...")        
    ...
    def save_model(self):
        ...
        self.saver.save(self.sess, './model/save/critic_model.ckpt')

    def load_model(self):
        try:
            self.saver.restore(self.sess, './model/load/critic_model.ckpt')
        except:
            pass
